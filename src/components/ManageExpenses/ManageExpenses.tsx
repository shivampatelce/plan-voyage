...
const ManageExpenses: React.FC = () => {
  ...
  const [settlementActivityCollapsed, setSettlementActivityCollapsed] =
    useState(true);
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="ghost"
              size="sm"
              onClick={() => setSettlementsCollapsed(!settlementsCollapsed)}
              className="flex items-center gap-2">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                setSettlementActivityCollapsed(!settlementActivityCollapsed)
              }
              className="flex items-center gap-2">
              {settlementActivityCollapsed ? (
                <ChevronDown className="w-4 h-4" />
              ) : (
                <ChevronUp className="w-4 h-4" />
              )}
